...
(function () {
  ...
  const T = {
    en: {
      ...
      reg_note:      '<strong>Important:</strong><br>Captain must be listed as one of the players below.<br><br>If any player is under 18, a <a href="/static/assets/documents/ZGODA_RODZICA_Pocket_Aces_12_04_2026_1.pdf" target="_blank">parental consent form</a> must be filled out and provided at registration.<br><br>Jersey numbers are optional, but if <strong>any</strong> player is missing a number, the <strong>entire team will not receive match statistics</strong>.',
    ...
    pl: {
      ...
      reg_note:      '<strong>Ważne:</strong><br>Kapitan musi być wymieniony jako jeden z zawodników poniżej.<br><br>Jeśli którykolwiek z zawodników ma mniej niż 18 lat, należy wypełnić <a href="/static/assets/documents/ZGODA_RODZICA_Pocket_Aces_12_04_2026_1.pdf" target="_blank">zgodę rodzica</a> i dostarczyć ją organizatorom.<br><br>Numery na koszulkach są opcjonalne, ale jeśli <strong>ktokolwiek</strong> nie będzie miał numeru, <strong>cała drużyna nie otrzyma statystyk meczowych</strong>.',
      reg_first:     'Imię',
      reg_last:      'Nazwisko',
      reg_jersey:    '#',
